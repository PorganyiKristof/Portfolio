    ...
    <section className="hero-section">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-8 place-self-center text-center sm:text-left sm:justify-self-start">
          <h1 className="text-white mb-4 text-4xl sm:text-6xl lg:text-7xl font-extrabold lg:leading-normal">
          ...
          <div>
            <button className="px-6 py-3  w-full sm:w-fit rounded-full mr-4 text-white bg-gradient-to-tr from-primary-800 via-primary-400-600 to-secondary-500 hover:bg-slate-300">
              Hire Me!
            </button>
